const eventData = [
  {
    ...
    description: `Join the 1-hour guest lecture by the chief guest of Version 24, delving
      ...
      gaining insights into its impact across fields. Engage in a Q&A session
      for a deeper understanding of this transformative technology.`,
  },
  {
    id: 2,
    name: "CodeBlitz",
    ...
    description: `The coding event consists of two rounds. The first round is online, to
      ...
      language. The final round takes place on campus during the event.
      Participation is individual. Platform: HackerEarth.`,
  },
  {
    id: 3,
    name: "Cryptic Coder",
    ...
    description: `CrypticCoder offers a challenging competition where participants
      ...
      and debugging skills. Success hinges on identifying and fixing errors,
      ensuring the corrected code passes hidden test cases.`,
  },
  {
    id: 4,
    name: "ImmerseCraft",
    ...
    description: `Generative Image Marvels invites participants to explore creativity
      ...
      limits. The event celebrates limitless possibilities, encouraging
      innovative and thought-provoking pieces. Join us in this journey of
      exploration and innovation in generative image generation.`,
  },
  {
    id: 5,
    name: "DecodeCraft",
    ...
    description: `Join the 1-hour fun-coding event where participants decode
      ...
      coders win recognition and prizes, adding excitement to the
      challenge.`,
  },
  {
    id: 6,
    ...
    description: `The gaming event of Version’24. The game Zombie Apocalypse is a
      ...
      higher than the other players on the leaderboard, finishing the
  ...
  },
  {
    ...
    description: `Squid Quiz, inspired by Squid Game, challenges participants with
      ...
      top ten advance to a tougher second round in this one-hour quiz on
      the Version website, providing an intense and competitive
      experience.`,
  },
  {
    id: 8,
    ...
    consist of some basic features, then some extra features can be
    added which will give some brownie points. 3-4 such questions can be
    given and they have to get as many points as possible.
    Team size : at max 2 members.`,
  },
  {
    id: 9,
    name: "Heads Up",
  ...
  },
  {
    ...
    2. Bombardier: Throws balls at opponents' castles to destroy them.
    3. Supply Maven: Collects and supplies balls to the Bombardier for
    strategic attacks.
    Teams battle to defend and attack castles using provided balls. The
    team with the most intact castle levels at the end wins.`,
  },
  {
    id: 11,
    name: "Map Quest",
    ...
    on a map.
    2. Each route contains multiple pointers with clues indicating vital
    information about associated cities and their answers.
    3. Routes require specific types of answers for progression.
    4. Additional clues can be obtained by expending points.
    5. Upon completing each route, participants must answer a
  ...
  },
  {
    ...
    resumes. The coveted 1st prize awaits the standout participant,
    promising ultimate recognition and reward for excellence at
    Destinite.`,
  },
];
